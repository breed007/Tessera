...
// Auto returns the best icon id for a device. Order: vendor brand (most
// recognizable), then OS, then device type, then the generic fallback.
func Auto(vendor, osGuess, deviceClass string) string {
